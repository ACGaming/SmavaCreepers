...
import mod.acgaming.smava.entity.ai.goal.SmavaCreeperSwellGoal;
...
public class SmavaCreeperEntity extends MonsterEntity implements IChargeableMob
{
	...
	public void tick()
	{
		if (this.isAlive())
		{
			...
			{
				this.playSound(SmavaRegistry.ENTITY_SMAVA_CREEPER_FUSE.get(), 1.0F, 1.0F);
			}
	...
	private void explode()
	{
		if (!this.world.isRemote)
		{
			...
			this.dead = true;
			this.playSound(SmavaRegistry.ENTITY_SMAVA_CREEPER_BLOW.get(), 1.0F, 1.0F);
